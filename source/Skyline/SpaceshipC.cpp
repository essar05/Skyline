...
SpaceshipC::SpaceshipC(): SpaceshipC(0, glm::vec4(0.0f), 0.0f, 0.0f, glm::vec2(0.0f, 0.0f), 0.0f) { }

SpaceshipC::SpaceshipC(int textureId, glm::vec4 uv, float width, float height, glm::vec2 position, float angle) : Entity(textureId, uv, width, height, position, angle) {
  initAnimations();
  initThruster();
  initProjectileSpawners();
}

SpaceshipC::~SpaceshipC() {
...
bool SpaceshipC::update(float deltaTime) {
  ...
  _projectileSpawnerLeftPosition = glm::vec2(-0.35f, 0.66f);
  _projectileSpawnerRightPosition = glm::vec2(0.47f, 0.66f);
...
void SpaceshipC::createFixtures() {
  ...
  b2Vec2 vertices2[4];
  vertices2[0].Set(-_width / 4.5f, 0.0f);
  vertices2[1].Set(_width / 4.5f, 0.0f);
  vertices2[2].Set(_width / 2.2f, -_height / 3.9f);
  vertices2[3].Set(-_width / 2.2f, -_height / 3.9f);
  ...
  boxShape3.SetAsBox(_width / 4, _height / 9, b2Vec2(0.0f, - _height / 3), 0.0f);
...
void SpaceshipC::initAnimations() {
  Ess2D::TextureAtlas * spaceshipAtlas = _game->getGameplayScreen()->getTextureCache()->getAtlas("Textures/SpaceshipC.png", "Textures/SpaceshipC.json");
  ...
  idleAnimation->setFrames(std::vector<std::string> {"spaceship_3_right_1"});
  ...
  bankLeftAnimation->setFrames(std::vector<std::string> {"spaceship_3_left_1", "spaceship_3_left_2", "spaceship_3_left_3", "spaceship_3_left_4", "spaceship_3_left_5", "spaceship_3_left_6", "spaceship_3_left_7", "spaceship_3_left_8", "spaceship_3_left_9", "spaceship_3_left_10"});
  ...
  bankRightAnimation->setFrames(std::vector<std::string> {"spaceship_3_right_1", "spaceship_3_right_2", "spaceship_3_right_3", "spaceship_3_right_4", "spaceship_3_right_5", "spaceship_3_right_6", "spaceship_3_right_7", "spaceship_3_right_8", "spaceship_3_right_9", "spaceship_3_right_10"});
...
void SpaceshipC::initThruster() {
  ...
  for(int i = 0; i <= 10; i++) {
    thrusterAnimationFrames.push_back("thruster_blue_" + std::to_string(i));
  }
